/**
 * FORMS_MADRASAH - Konfigurasi Form untuk Kepala Madrasah (Kamad)
 * Salin dari Madrasah/Forms.js dengan tambahan allowed_roles.
 *
 * allowed_roles — array role yang boleh MENGISI form ini:
 *   [kamad]             → hanya kamad yang bisa isi
 *   [kamad, madrasah]   → kamad dan admin madrasah bisa isi
 *   [district]          → hanya district, kamad read-only
 *   tidak ada (atau []) → kamad read-only
 *
 * SCHEMA:
 * - title: Display title of the survey
 * - target_sheet: Name of the sheet to save data to
 * - questions: List of fields
 * - allowed_roles: which roles can FILL this form (kamad, madrasah, district, ...)
 */
